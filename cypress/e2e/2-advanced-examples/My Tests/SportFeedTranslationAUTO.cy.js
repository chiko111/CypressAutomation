describe('testing token', () => {
  ...
  it("Sport translate bg", () => {
    ...
    cy.request({
      ...
      env.trresponse_req1 = response.body[0].categories[0].tournaments[0].name
      env.trresponse_id2 = response.body[0].categories[0].tournaments[1].id
      env.trresponse_req2 = response.body[0].categories[0].tournaments[1].name
      env.trresponse_id3 = response.body[0].categories[0].tournaments[2].id
      env.trresponse_req3 = response.body[0].categories[0].tournaments[2].name
